...
extension MySQL {
    ...
    internal struct Utils {
        ...
        static func lenEncInt(_ b: [UInt8]) -> (UInt64?, Int) {
            ...
            case 0xfe:
                let xxx:UInt64 = UInt64(b[1]) | UInt64(b[2])<<8
                let yyy:UInt64 =  UInt64(b[3])<<16 |
                    UInt64(b[4])<<24
                let zzz:UInt64 =   UInt64(b[5])<<32 | UInt64(b[6])<<40
...
extension Int {
    init(_ arr:ArraySlice<UInt8>) {
        ...
        //self = res
        let xxx = Int(arr[arr.startIndex + 3])<<24 | Int(arr[arr.startIndex + 2])<<16
        self = xxx | Int(arr[arr.startIndex + 1])<<8 | Int(arr[arr.startIndex])
    }
...
extension Sequence where Iterator.Element == UInt8 {
    ...
    func int32() -> Int32 {
        ...
        let xxx:Int32 = Int32(arr[3])<<24 | Int32(arr[2])<<16
        let yyy:Int32 =  Int32(arr[1])<<8
        return xxx |  yyy | Int32(arr[0])
    }
    ...
    func uInt32() -> UInt32 {
        ...
        let xxx:UInt32 = UInt32(arr[3])<<24 | UInt32(arr[2])<<16
        return xxx | UInt32(arr[1])<<8 | UInt32(arr[0])
    }
